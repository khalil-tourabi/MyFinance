...
import { getCategoriesSlice, modifyCategorieSlice } from "../../state/categories/categoriesSlice";

export default function EditBudgetModal({
  categorieId,
  categorieInitialData,
  onClose,
}) {
  ...
  useEffect(() => {
    if (categorieInitialData) {
      setCategorieData(categorieInitialData);
    }
  }, [categorieInitialData]);
  ...
  const handleSubmit = async (e) => {
    ...
    if (!categorieData.nomCategorie) {
      alert("Nom de categorie est obligatoire!");
      return;
    }

    try {
      await dispatch(
        modifyCategorieSlice({ id: categorieId, data: categorieData })
      ).unwrap();
                      ...
                      <form onSubmit={handleSubmit}>
                        <div className="mb-5">
                          ...
                          <input
                            ...
                            id="base-input"
                            name="nomCategorie"
                            value={categorieData.nomCategorie}
                        ...
                        <div className="mb-5">
                          ...
                          <input
                            ...
                            value={categorieData.budgetCategorie}
                            onChange={handleChange}
                            className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                          />
                        </div>
