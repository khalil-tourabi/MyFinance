...
import { register } from "../../state/users/usersSlice";
...
const Register = () => {
  ...
  const handlePasswordConfirmationChange = (e) => {
    ...
    setPasswordConfirmaiton({password_confirmation: value})
  }
  ...
  const handleSubmit = (e) => {
    ...
    if(newUser.password !== PasswordConfirmation.password_confirmation) {
              ...
              <form onSubmit={handleSubmit} className="mt-8 grid grid-cols-6 gap-6">
                ...
                <div className="col-span-6 sm:col-span-3">
                  ...
                  <input
                    ...
                    value={PasswordConfirmation.password_confirmation}
